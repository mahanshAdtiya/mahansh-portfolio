...
export function Hero() {
  return (
    <section
      id="top"
      className="mx-auto grid max-w-page items-center gap-[clamp(30px,5vh,44px)] px-gutter pt-[clamp(24px,4vh,40px)] lg:pt-0 lg:min-h-[72svh] lg:grid-cols-[1fr_min(40vw,400px)] lg:gap-14"
    >
      <div>
